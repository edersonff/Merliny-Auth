import { TermsContainer } from "@/styles/terms";
    ...
    <TermsContainer>
      ...
      <p>
        <span style={{ color: "rgb(68, 68, 68)" }}>
          ...
          materiais (informações ou software) no site Merliny Invest , apenas
      ...
      <ol>
        ...
        <li>
          <span style={{ color: "rgb(68, 68, 68)" }}>
            ...
            contido no site Merliny Invest;&nbsp;
          </span>
        </li>
        <li>
          <span style={{ color: "rgb(68, 68, 68)" }}>
      ...
      <p>
        <span style={{ color: "rgb(68, 68, 68)" }}>
          ...
          dessas restrições e poderá ser rescindida por Merliny Invest a
      ...
      <ol>
        <li>
          <span style={{ color: "rgb(68, 68, 68)" }}>
            Os materiais no site da Merliny Invest são fornecidos &apos;como
            estão&apos;. Merliny Invest não oferece garantias, expressas ou
      ...
      <p>
        <span style={{ color: "rgb(68, 68, 68)" }}>
          Os materiais exibidos no site da Merliny Invest podem incluir erros
          técnicos, tipográficos ou fotográficos. Merliny Invest não garante que
          qualquer material em seu site seja preciso, completo ou atual. Merliny
          Invest pode fazer alterações nos materiais contidos em seu site a
          qualquer momento, sem aviso prévio. No entanto, Merliny Invest não se
      ...
      <p>
        <span style={{ color: "rgb(68, 68, 68)" }}>
          O Merliny Invest não analisou todos os sites vinculados ao seu site e
          não é responsável pelo conteúdo de nenhum site vinculado. A inclusão
          de qualquer link não implica endosso por Merliny Invest do site. O uso
      ...
      <p>
        <span style={{ color: "rgb(68, 68, 68)" }}>
          O Merliny Invest pode revisar estes termos de serviço do site a
      ...
      <p>
        <span style={{ color: "rgb(68, 68, 68)" }}>
          ...
          leis do Merliny Invest e você se submete irrevogavelmente à jurisdição
